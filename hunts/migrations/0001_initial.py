    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unlock_type', models.CharField(choices=[('SOLVES_UNLOCK', 'Solves Based Unlock'), ('POINTS_UNLOCK', 'Points Based Unlock'), ('EITHER_UNLOCK', 'Either (OR) Unlocking Method'), ('BOTH_UNLOCK', 'Both (AND) Unlocking Methods')], default='SOLVES_UNLOCK', help_text='The type of puzzle unlocking scheme', max_length=13)),
