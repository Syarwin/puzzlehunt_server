# Generated by Django 3.1.7 on 2021-04-29 15:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unlock_type', models.CharField(choices=[(teams.models.UnlockType['SOLVES_UNLOCK'], 'Solves Based Unlock'), (teams.models.UnlockType['POINTS_UNLOCK'], 'Points Based Unlock'), (teams.models.UnlockType['EITHER_UNLOCK'], 'Either (OR) Unlocking Method'), (teams.models.UnlockType['BOTH_UNLOCK'], 'Both (AND) Unlocking Methods')], default=teams.models.UnlockType['SOLVES_UNLOCK'], help_text='The type of puzzle unlocking scheme', max_length=3)),
